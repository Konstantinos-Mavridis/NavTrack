                      ...
                      <thead className="bg-gray-50 dark:bg-gray-800/60">
                        <tr>
                          {['Date', 'Fund', 'Type', 'Units', 'Price (EUR)', 'Fees (EUR)', 'Total (EUR)', ''].map((h) => (
                            <th key={h} className="table-th-sm">{h}</th>
                          ))}
                        </tr>
                      </thead>
                      <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                        {transactions.map((tx) => {
                          ...
                          return (
                            <tr key={tx.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors group">
                              <td className="table-td-sm font-mono text-gray-500 dark:text-gray-400 whitespace-nowrap">{tx.tradeDate}</td>
                              <td className="table-td-sm font-medium text-gray-800 dark:text-gray-200 max-w-[14rem]">
                              ...
                              <td className={`table-td-sm tabular-nums ${unitsCls}`}>
                                {fmtTxUnits(tx.units, txType)}
                              </td>
                              <td className="table-td-sm tabular-nums">{fmtEur(tx.pricePerUnit, 6)}</td>
                              <td className="table-td-sm tabular-nums text-gray-500 dark:text-gray-400">{fmtEur(tx.fees)}</td>
                              <td className="table-td-sm tabular-nums font-medium">€{fmtEur(total)}</td>
                              <td className="table-td-sm">
