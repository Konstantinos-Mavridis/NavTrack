...
export default function PortfolioDetail() {
  ...
  // ── Silent auto-recalculate ──────────────────────────────────────────────────────
  // Runs in the background after every ledger mutation; refreshes valuation once done.
  async function autoRecalculate(portfolioId: string, valuationDate: string) {
    try {
      ...
      // Non-fatal — positions will just be slightly stale until next reload
    }
  }
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-8">
      ...
      <div className="card overflow-hidden">
        ...
        {/* Import/Export footer — shown only on the transactions tab */}
        {tab === 'transactions' && (
