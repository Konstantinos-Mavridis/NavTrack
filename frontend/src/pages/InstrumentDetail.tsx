  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-10 space-y-8">
      ...
      <div className="card p-6">
        ...
        {saveMsg && <p className="text-emerald-600 dark:text-emerald-400 text-sm mt-3">✓ {saveMsg}</p>}
        {saveErr && <p className="text-red-500 dark:text-red-400 text-sm mt-3">✗ {saveErr}</p>}
      </div>
