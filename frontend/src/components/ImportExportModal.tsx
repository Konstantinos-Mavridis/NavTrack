  ...
  return (
    <>
      ...
      {open && (
        ...
        >
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-xl dark:shadow-black/60 w-full max-w-md mx-4 overflow-hidden border border-transparent dark:border-gray-700">
            ...
            <div className="px-6 py-5 space-y-6">
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <ActionCard
                    working={working === 'export-json'}
                    idleEmoji="📄" idleLabel="JSON" sub="Full data backup"
                    disabled={!!working} hoverColor="blue" onClick={handleExportJson} />
                  <ActionCard
                    working={working === 'export-csv'}
                    idleEmoji="📊" idleLabel="CSV" sub="Spreadsheet-friendly"
                    disabled={!!working} hoverColor="blue" onClick={handleExportCsv} />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <ActionCard
                    working={working === 'import-json'}
                    idleEmoji="📥" idleLabel="JSON" sub=".json file"
                    disabled={!!working} hoverColor="emerald"
                    onClick={() => jsonInputRef.current?.click()} />
                  <ActionCard
                    working={working === 'import-csv'}
                    idleEmoji="📥" idleLabel="CSV" sub=".csv file"
                    disabled={!!working} hoverColor="emerald"
...
function ActionCard({
  working, idleEmoji, idleLabel, sub, disabled, hoverColor, onClick,
}: {
  working: boolean;
  idleEmoji: string;
  idleLabel: string;
