...
describe('PortfoliosController', () => {
  ...
  // NOTE: PortfoliosController does not expose a valuation endpoint —
  // valuation lives on ValuationController at GET /portfolios/:id/valuation.
  // This test verifies the ValuationService mock is wired up correctly.
  it('ValuationService mock resolves compute correctly', async () => {
    const result = await valuationSvc.compute!('p1', undefined);
